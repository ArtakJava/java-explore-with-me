...
public class MessageHolder {
    ...
    public static final String GET_REQUEST_STATS_SUCCESS = "Запрос на получение статистики от {} до {} успешно выполнен.";
    public static final String END_BEFORE_START = "Дата окончания указана раньше времени даты начала.";
    public static final String START_EQUAL_END = "Указаны одинаковые даты начала и окончания.";
}